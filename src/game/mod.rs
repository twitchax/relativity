...
use self::{
    ...
    hud::{hud_flash_system, hud_glow_pulse_system, observer_hud_text_update, player_hud_text_update, sim_rate_hud_update, HudPlugin},
    ...
    player::{
        ...
        player_sprite::{launch_aim_system, launch_fire_system, launch_power_system, launch_preview_system, launch_visual_system},
    },
    shared::{
        systems::{
...
impl Plugin for GamePlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(HudPlugin)
            ...
            .add_systems(
                Update,
                (trail_render_system, gravity_grid_render_system, sim_rate_hud_update, hud_glow_pulse_system).run_if(in_state(AppState::InGame)),
            )
